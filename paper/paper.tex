...
the expression. To achieve minimization to an unreducible (not optimizable)
form, optimizer calls are iterated on each previous call's result; this way,
when a tree representing an expression cannot be optimized again.
This is the process represented in pseudo-code:
