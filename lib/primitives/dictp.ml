...
let table = [
  ("insert",         Primitive (insert_dict, ("insert", [|"key"; "value"; "dict"|], Pure)));
  ("remove",         Primitive (delete_dict, ("remove", [|"key"; "dict"|], Pure)));
  ("haskey",         Primitive (haskey, ("haskey", [|"key"; "dict"|], Pure)));
  ("getkeys",        Primitive (getkeys, ("getkeys", [|"dict"|], Pure)));
  ("getvalues",      Primitive (getvalues, ("getvalues", [|"dict"|], Pure)));
  ("dictfromlists",  Primitive (dict_from_lists, ("dictfromlists", [|"key_list"; "value_list"|], Pure)));
  ("filterkeys",     Primitive (filterkeys, ("filterkeys", [|"key_list"; "dict"|], Pure)))
]
